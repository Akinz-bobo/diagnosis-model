...
export function AppearanceForm({ user }: { user: User }) {
  ...
  // In a real app, this would come from the user's preferences in the database
  const form = useForm<AppearanceFormValues>({
    resolver: zodResolver(appearanceFormSchema),
    defaultValues: {
      theme: user.appearancePreferences?.theme || "system",
    },
  });
  ...
  async function onSubmit(data: AppearanceFormValues) {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "Failed to update appearance preferences. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
